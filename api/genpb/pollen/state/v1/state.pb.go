...
type RevocationChange struct {
	...
	Revocation    *v1.SignedRevocation   `protobuf:"bytes,2,opt,name=revocation,proto3" json:"revocation,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RevocationChange) GetSubjectPub() []byte {
	if x != nil {
		return x.SubjectPub
	}
	return nil
...
const file_pollen_state_v1_state_proto_rawDesc = "" +
	...
	"\fidentity_pub\x18\x01 \x01(\fB\a\xbaH\x04z\x02h R\videntityPub\"\x83\x01\n" +
	"\x10RevocationChange\x12(\n" +
	"\vsubject_pub\x18\x01 \x01(\fB\a\xbaH\x04z\x02h R\n" +
	"subjectPub\x12E\n" +
	"\n" +
	"revocation\x18\x02 \x01(\v2%.pollen.admission.v1.SignedRevocationR\n" +
	"revocation\"\x9b\x04\n" +
	"\vGossipEvent\x124\n" +
