...
func (x *CertificateInfo) GetNotBeforeUnix() int64 {
	if x != nil {
...
func (x *CertificateInfo) GetNotAfterUnix() int64 {
	if x != nil {
...
type GetStatusResponse struct {
	...
	Certificates  []*CertificateInfo     `protobuf:"bytes,5,rep,name=certificates,proto3" json:"certificates,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetStatusResponse) GetCertificates() []*CertificateInfo {
	if x != nil {
...
const file_pollen_control_v1_control_proto_rawDesc = "" +
	...
	"\vconnections\x18\x04 \x03(\v2$.pollen.control.v1.ConnectionSummaryR\vconnections\x12F\n" +
	"\fcertificates\x18\x05 \x03(\v2\".pollen.control.v1.CertificateInfoR\fcertificates\"\xc0\x01\n" +
