...
// root (e.g. sudo pln init), atomicWrite chowns files to pln:pln
// automatically. When the pln user doesn't exist (e.g. macOS, dev
// machines), chown is a no-op.
//
...
//	state.pb                   pln:pln        0600   WritePrivate (supervisor)
//	pln.sock                   pln:pln        0660   SetGroupSocket
//	cas/                       pln:pln        0770   EnsureDir
//	cas/<shard>/               pln:pln        0770   EnsureDir
package config
